...
class SVDDenseDistr {
    ...
    private static final String[] dataset = { dataRoot + "/data/distributed/svd_1.csv", dataRoot + "/data/distributed/svd_2.csv",
            dataRoot + "/data/distributed/svd_3.csv", dataRoot + "/data/distributed/svd_4.csv" };
