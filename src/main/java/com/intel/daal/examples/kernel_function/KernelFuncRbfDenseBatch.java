...
class KernelFuncRbfDenseBatch {
    ...
    private static final String leftDatasetFileName  = dataRoot + "/data/batch/kernel_function.csv";
    private static final String rightDatasetFileName = dataRoot + "/data/batch/kernel_function.csv";
